...
def predict(args, test_loader, model):
    ...
    for i, (input, lable, size, name) in enumerate(test_loader):
        with torch.no_grad():
        ...
        name[0] = name[0].rsplit('_', 1)[0]+str(name)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default="TSPN", help="TSPN")
    parser.add_argument('--dataset', default="camvid", help="camvid")
    parser.add_argument('--num_workers', type=int, default=1, help="the number of parallel threads")
    parser.add_argument('--batch_size', type=int, default=1,
                        help=" the batch_size is set to 1 when evaluating or testing")
    parser.add_argument('--checkpoint', type=str,
                        default="./checkpoint/camvid/TSPNbs4gpu1_trainval/model.pth",
